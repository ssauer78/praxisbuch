...
public class DisplayExport {
	...
	protected static TableView<Service> createExportTableView() throws ParseException {
		TableView<Service> exportTable = new TableView<Service>();
        					...
        					public void handle(ActionEvent event) {
        						...
        						try {
        							...
        							if (result.get() == ButtonType.OK){
    									...
    									TableView<Service> tv = createExportTableView();
        ...
        exportTable.getColumns().addAll(serviceActionColumn, serviceNameColumn, serviceCostColumn);
